...
RESULT=$(dialog --stdout --default-item 1 --title "Yiimpool Yiimp installer v3.0" --menu "Choose one" -1 60 6 \
' ' "- Install Without wireguard installed use the following option -" \
